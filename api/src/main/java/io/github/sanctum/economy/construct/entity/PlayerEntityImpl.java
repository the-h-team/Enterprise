...
class PlayerEntityImpl<T> extends EnterpriseEntityImpl implements PlayerEntity<T> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PlayerEntityImpl<?>)) return false;
        if (!super.equals(o)) return false;
        PlayerEntityImpl<?> that = (PlayerEntityImpl<?>) o;
        return identifyingProperty.equals(that.identifyingProperty);
    }

    @Override
    public int hashCode() {
        int result = super.hashCode();
        result = 31 * result + identifyingProperty.hashCode();
        return result;
    }

    @Override
    public String toString() {
        return "PlayerEntity." + getClass().getSimpleName() + "{" +
