...
public class EnterpriseEntity {
     ...
     * @since 2.0.0
     */
    public static class PlayerByUUID extends AbstractPlayerEntity implements PlayerEntity {
     ...
     * @since 2.0.0
     */
    public static class PlayerByUsername extends AbstractPlayerEntity implements PlayerEntity {
